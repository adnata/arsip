...
<div>
    <div wire:ignore.self class="modal modal-blur fade" id="JenisUbahModal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text"
                                    ...
                                    placeholder="Masukkan jenis" wire:model="nama_jenis">
